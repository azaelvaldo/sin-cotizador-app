...
export default function QuotationForm({ onSuccess }: QuotationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (onSuccess) {
        onSuccess(quotationData as unknown as Quotation)
      }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Complete el formulario para crear una nueva cotización de seguro agrícola</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData((prev) => ({ ...prev, insuredArea: e.target.value }))}
                disabled
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData((prev) => ({ ...prev, insuredAmount: e.target.value }))}
                disabled={isSubmitting || createLoading}
              />
            </div>
          ...
          {success && (
            <Alert className="border-green-200 bg-green-50">
              ...
              <AlertDescription className="text-green-800">Cotización creada exitosamente</AlertDescription>
            </Alert>
          )}
